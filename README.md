...
then it converts it to a PDF file on a temporary location relative to where the application is being ran and uses the 
new PDF file location instead of the [DOCX](https://www.howtogeek.com/304622/what-is-a-.docx-file-and-how-is-it-different-from-a-.doc-file-in-microsoft-word/)
location.
...
files to PDF with [documents4j](https://documents4j.com/#/).
